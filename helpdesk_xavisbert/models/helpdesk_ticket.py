...
class HelpdeskTicket(models.Model):
    ...
    description = fields.Text(string='Descripción', transalte=True)
    ...
    action_preventive = fields.Html(string='Preventive Action', help='Descrive preventive actions to do')
    def asignar(self):
        self.ensure_one()
        self.write({'state': 'asignado', 'assigned': True})
    def proceso(self):
        self.ensure_one()
        self.state = 'proceso'
    def pendiente(self):
